...
При поиске совпадений только по автору или только по наименованию, результаты в файле скорее всего будут, но это ещё не значит, что книги находятся в списке, необходимо внимательно изучить результаты обработки, чтобы сделать окончательный вывод.
